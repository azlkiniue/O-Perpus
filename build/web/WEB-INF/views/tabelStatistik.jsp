...
//  });
  function activator(){
    document.getElementById("statistik").className="active";
  }
  </script>
  <style>
    ...
    .navbar.navbar-default{
      background: linear-gradient(to right, rgba(255, 255, 255, 0.9) 12%,  rgba(255, 255, 255, 0.5) 50%, rgba(255, 255, 255, 0) 90%), url('/Project_Library/assets/img/pattern-8.jpg');
    }
    text{
