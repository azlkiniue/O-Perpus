...
$(function() {
    $(document).ready(function(){
      $.getJSON( "http://localhost:8080/Project_Library/json/gender", function( obj ) {
        // Donut Chart
        $.each(obj, function() {
            if (this.label == "L") {
        ...
        $.getJSON( "http://localhost:8080/Project_Library/json/peminjaman", function( obj ) {
          // Line Chart
          Morris.Line({
      ...
      $.getJSON( "http://localhost:8080/Project_Library/json/anggota", function( obj ) {
        // Area Chart
        Morris.Area({
      ...
      $.getJSON( "http://localhost:8080/Project_Library/json/umurAnggota", function( obj ) {
        // Bar Chart
        Morris.Bar({
